 ...
 * @LastEditTime: 2022-04-22 15:50:38
...
admin/usertenant/material/smallType/402

localStorage.setItem('code','081gR00w3RM1nY2EYP2w3EJ9Sd3gR00i')

localStorage.setItem('authority','56_qJbz0H-GXTe2I0OotK8S0J8sx3IIOGaDBLsNjDkRmWTAxxoEgLJmV5MD_wj-korK-ChGjhg59NGUfbjZoOKB8g')



update saas_master.t_image set img_path = 'http://172.169.73.39:8012/onlinePreview?url=aDT6M%2Frq7sgn2zwyH8e5Jb3GMW2AuF3ouVFduwfTyqFyMSOLA2dyuXNzdB1vTNANqzI6pcpPKnSi6RmgfVl68wfC1%2BhYBdDgJY76VeYin2E%3D', img_file = 'group1/M00/00/0C/rKlJJmIy1FiAYLTNAAJwdT-i7Zg572.jpg' where material_id = (
select material_id from saas_master.t_user_tenant where english_short = 'slave') and small_code = '402';
update saas_master.t_image set img_path = 'http://172.169.73.39:8012/onlinePreview?url=aDT6M%2Frq7sgn2zwyH8e5Jb3GMW2AuF3ouVFduwfTyqE8itRFUoQb%2Bn96z27vx9yo5yIsA8xFkCJwmqRLsaBoi4wBWuwMuHGH23y37Ah0sDk%3D', img_file = 'group1/M00/00/0C/rKlJJmIy0_uAbZSGAAEMWuxkEw8214.jpg' where material_id = (
select material_id from saas_master.t_user_tenant where english_short = 'slave') and small_code = '401';
```
