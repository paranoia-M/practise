 ...
 * @LastEditTime: 2022-04-22 10:16:53
...
- 案例
  头像上传，在上传之前模块外部容器设置 visibility:hidden，裁剪区域里面放一个加载效果设置 visibility:visible，图片尺寸获取成功后，在正常初始化
...
**localStorage.setItem('code','031GLfll2zmN294ae4ml2xd3473GLfli')
localStorage.setItem('authority','56_K4a_CXU2vF-f-7I6nQeaM2fY2a7vL9FJePKpa_S8OiMDIiky4dDuHA-OwnoauZ0RQL2oA8UPb8OHKCKouI12Gg')**
```
