 ...
 * @LastEditTime: 2021-07-15 21:07:36
...
-   监听复选框的状态: 先拿当前元素的 id(因为 id 是数组里面自带的键名，所以可以直接访问到当前元素的 id)，并且用一个对象把当前获取到的 id 和 status 保存起来， 把该对象当作参数传到 mutations 里面，根据当前元素的 id 来获取当前元素的索引
-
-
-
-   1824186580@qq.com
